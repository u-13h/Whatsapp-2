...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2025 a las 13:07:31
...
--
-- Estructura de tabla para la tabla `messages_grupo`
--
...
ALTER TABLE `grupo_miembros`
  ...
  ADD KEY `fk_gm_usuario` (`id_usuario`);
...
--
-- Indices de la tabla `messages_grupo`
--
ALTER TABLE `messages_grupo`
  ADD PRIMARY KEY (`id_mensaje`),
  ADD KEY `fk_mg_grupo` (`id_grupo`),
  ADD KEY `fk_mg_emisor` (`emisor`);
...
--
-- AUTO_INCREMENT de la tabla `messages_grupo`
--
ALTER TABLE `messages_grupo`
  MODIFY `id_mensaje` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `grupo_miembros`
  ADD CONSTRAINT `fk_gm_grupo` FOREIGN KEY (`id_grupo`) REFERENCES `grupos` (`id_grupo`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_gm_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE;
...
--
-- Filtros para la tabla `messages_grupo`
--
ALTER TABLE `messages_grupo`
  ADD CONSTRAINT `fk_mg_emisor` FOREIGN KEY (`emisor`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_mg_grupo` FOREIGN KEY (`id_grupo`) REFERENCES `grupos` (`id_grupo`) ON DELETE CASCADE;
COMMIT;
